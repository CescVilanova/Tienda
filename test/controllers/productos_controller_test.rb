...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { added: @producto.added, description: @producto.description, manufacturer: @producto.manufacturer, name: @producto.name, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { added: @producto.added, description: @producto.description, manufacturer: @producto.manufacturer, name: @producto.name, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
